...
docker exec -it \\
  ...
  --enable_cameras \\
  --env_graph_spec_yaml {yaml_rel} \\
  --output_base_dir /workspaces/isaaclab_arena/eval_output/{env_name}_gr00t_single
```
...
docker exec -it \\
  ...
  --policy_device cuda \\
  --env_graph_spec_yaml {yaml_rel} \\
  --output_base_dir /workspaces/isaaclab_arena/eval_output/{env_name}_gr00t_parallel
```
