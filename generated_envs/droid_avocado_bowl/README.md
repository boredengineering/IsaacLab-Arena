...
docker exec -it \
  ...
  --enable_cameras \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_avocado_bowl/droid_avocado_to_bowl.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_avocado_to_bowl_gr00t_single
```
...
docker exec -it \
  ...
  --policy_device cuda \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_avocado_bowl/droid_avocado_to_bowl.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_avocado_to_bowl_gr00t_parallel
```
