# Environment: `droid_rubiks_cube_to_blue_bin`
...
* **Task Description**: Pick up the Rubik's cube from the maple table and place it into the blue bin.
* **Task Composition**: `TaskCompositionType.ATOMIC`
* **Embodiment**: `droid_abs_joint_pos`
* **Background Anchor**: `maple_table_robolab`
* **Scene Objects**: `rubiks_cube` (`rubiks_cube_hot3d_robolab`), `blue_bin` (`bin_b03_vomp_robolab`)
* **Spec YAML**: [`droid_rubiks_cube_to_blue_bin.yaml`](droid_rubiks_cube_to_blue_bin.yaml)
...
docker exec -it \
  ...
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_rubiks_cube_to_blue_bin_eval
```
...
docker exec -it \
  ...
  --enable_cameras \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_rubiks_sector_verified/droid_rubiks_cube_to_blue_bin.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_rubiks_cube_to_blue_bin_gr00t_single
```
...
docker exec -it \
  ...
  --policy_device cuda \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_rubiks_sector_verified/droid_rubiks_cube_to_blue_bin.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_rubiks_cube_to_blue_bin_gr00t_parallel
```
...
docker exec -it \
  ...
  --out_dir /workspaces/isaaclab_arena/generated_envs/droid_rubiks_sector_verified_refined
```
...
docker exec -it \
  ...
  --assets rubiks_cube_hot3d_robolab bin_b03_vomp_robolab \
...
```cypher
MATCH (e:EnvironmentGraph {name: "droid_rubiks_cube_to_blue_bin"})
