...
class VisualSceneCritic:
    ...
    def _call_cloud_vlm_critic(self, spec: ArenaEnvGraphSpec, images: dict[str, Any]) -> VisualCriticResult:
        ...
        prompt = (
            ...
            "Inspect the camera views (egocentric robot head camera and orthogonal observer view) and evaluate:\n"
            ...
            "3. Is the robot standing at a feasible reach elevation relative to the work surface?\n\n"
