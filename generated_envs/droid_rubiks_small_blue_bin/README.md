...
docker exec -it \
  ...
  --base_spec /workspaces/isaaclab_arena/generated_envs/droid_rubiks_small_blue_bin/droid_pick_rubiks_cube_to_blue_bin.yaml \
  --feedback "Your refinement instruction here..." \
  --out_dir /workspaces/isaaclab_arena/generated_envs/droid_rubiks_small_blue_bin_refined
```
