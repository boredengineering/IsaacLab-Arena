# Environment: `droid_pick_rubiks_cube_to_wooden_bowl`
...
* **Task Description**: Droid robot picks up the Rubik's cube from the maple table and places it into the wooden bowl, with a banana placed next to the Rubik's cube on the table.
* **Task Composition**: `TaskCompositionType.ATOMIC`
* **Embodiment**: `droid_abs_joint_pos`
* **Background Anchor**: `maple_table_robolab`
* **Scene Objects**: `rubiks_cube` (`rubiks_cube_hot3d_robolab`), `wooden_bowl` (`wooden_bowl_hot3d_robolab`), `banana` (`banana_ycb_robolab`)
* **Spec YAML**: [`droid_pick_rubiks_cube_to_wooden_bowl.yaml`](droid_pick_rubiks_cube_to_wooden_bowl.yaml)
...
docker exec -it \
  ...
  --num_envs 1 \
  --enable_cameras \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_rubiks_banana_bowl/droid_pick_rubiks_cube_to_wooden_bowl.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_pick_rubiks_cube_to_wooden_bowl_eval
```
...
docker exec -it \
  ...
  --enable_cameras \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_rubiks_banana_bowl/droid_pick_rubiks_cube_to_wooden_bowl.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_pick_rubiks_cube_to_wooden_bowl_gr00t_single
```
...
docker exec -it \
  ...
  --policy_device cuda \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_rubiks_banana_bowl/droid_pick_rubiks_cube_to_wooden_bowl.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_pick_rubiks_cube_to_wooden_bowl_gr00t_parallel
```
...
docker exec -it \
  ...
  --base_spec /workspaces/isaaclab_arena/generated_envs/droid_rubiks_banana_bowl/droid_pick_rubiks_cube_to_wooden_bowl.yaml \
  --feedback "Your refinement instruction here..." \
  --out_dir /workspaces/isaaclab_arena/generated_envs/droid_rubiks_banana_bowl_refined
```
...
docker exec -it \
  ...
  --assets rubiks_cube_hot3d_robolab wooden_bowl_hot3d_robolab banana_ycb_robolab \
...
```cypher
MATCH (e:EnvironmentGraph {name: "droid_pick_rubiks_cube_to_wooden_bowl"})
