...
| P04-I03 | [Full live scene workflow (Plan 03 V1)](03-full-scene-workflow.md) | Proposed; scaffolded & specified | Gate A preflight & operator issuance | Not issued; explicit cumulative envelope: max 2 native launches, max 4 provider calls, 1200s deadline |
