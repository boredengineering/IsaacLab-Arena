# Environment: `g1_wireshelving_pick_and_place`
...
* **Task Description**: Unitree G1 humanoid pick up brown box from the wireshelving in galileo room and place it into the blue sorting bin
* **Task Composition**: `TaskCompositionType.ATOMIC`
* **Embodiment**: `g1_wbc_pink`
* **Background Anchor**: `galileo`
* **Scene Objects**: `wireshelving` (`wireshelving_a01_vomp_robolab`), `brown_box` (`brown_box`), `blue_sorting_bin` (`blue_sorting_bin`)
* **Spec YAML**: [`g1_wireshelving_pick_and_place.yaml`](g1_wireshelving_pick_and_place.yaml)
...
docker exec -it \
  ...
  --output_base_dir /workspaces/isaaclab_arena/eval_output/g1_wireshelving_pick_and_place_eval
```
...
docker exec -it \
  ...
  --base_spec /workspaces/isaaclab_arena/generated_envs/g1_box_pnp/g1_wireshelving_pick_and_place.yaml \
  --feedback "Your refinement instruction here..." \
  --out_dir /workspaces/isaaclab_arena/generated_envs/g1_box_pnp_refined
```
...
docker exec -it \
  ...
  --assets wireshelving_a01_vomp_robolab brown_box blue_sorting_bin \
...
```cypher
MATCH (e:EnvironmentGraph {name: "g1_wireshelving_pick_and_place"})
