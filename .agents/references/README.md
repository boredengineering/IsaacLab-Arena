...
- **[dcrg_rl_fidelity_and_epistemic_telemetry_repair_plan.md](file:///workspaces/IsaacLab-Arena/.agents/references/plans/dcrg_rl_fidelity_and_epistemic_telemetry_repair_plan.md)**: **[CURRENT ACTIVE PLAN]** Autopsy and complete implementation of grounded RL rewards, anti-swatting regularization, JSONL predicate ingestion to Neo4j, and SHACL evaluation integrity invariants.
