# Environment: `droid_pick_apple_to_bowl`
...
* **Task Description**: Droid robot picks up a red apple from the maple table and places it into a wooden bowl that is also on the table.
* **Task Composition**: `TaskCompositionType.ATOMIC`
* **Embodiment**: `droid_abs_joint_pos`
* **Background Anchor**: `maple_table_robolab`
* **Scene Objects**: `red_apple` (`apple_01_objaverse_robolab`), `wooden_bowl` (`wooden_bowl_hot3d_robolab`)
* **Spec YAML**: [`droid_pick_apple_to_bowl.yaml`](droid_pick_apple_to_bowl.yaml)
...
docker exec -it \
  ...
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_pick_apple_to_bowl_eval
```
...
docker exec -it \
  ...
  --enable_cameras \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_apple_bowl/droid_pick_apple_to_bowl.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_pick_apple_to_bowl_gr00t_single
```
...
docker exec -it \
  ...
  --policy_device cuda \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_apple_bowl/droid_pick_apple_to_bowl.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_pick_apple_to_bowl_gr00t_parallel
```
...
docker exec -it \
  ...
  --base_spec /workspaces/isaaclab_arena/generated_envs/droid_apple_bowl/droid_pick_apple_to_bowl.yaml \
  --feedback "Your refinement instruction here..." \
  --out_dir /workspaces/isaaclab_arena/generated_envs/droid_apple_bowl_refined
```
...
docker exec -it \
  ...
  --assets apple_01_objaverse_robolab wooden_bowl_hot3d_robolab \
...
```cypher
MATCH (e:EnvironmentGraph {name: "droid_pick_apple_to_bowl"})
