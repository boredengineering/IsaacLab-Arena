...
- [P04-I02: Installed visual assessment of retained native evidence](plan04_implementation/02-installed-visual-assessment.md) — Parent-closed after final ACCEPT. Original lifecycle recovered; one provider request yielded a valid uncertain visibility result. Exact-byte readback, no-effect replay, physical cleanup, retirement and API drain verified within the original window. No scene acceptance or broader completion.
