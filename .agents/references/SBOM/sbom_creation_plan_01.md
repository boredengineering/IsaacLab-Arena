...
Status: proposed execution plan; documentation only. No scanner has been installed and no SBOM has been generated by this work.

Prepared: 2026-09-18. This is the canonical SBOM plan in this directory. The current request authorizes drafting and reviewing this plan, not tool installation, scanning private state, image downloads, builds, CI changes or publication. Workflow-refactoring implementation is on hold while this SBOM work is considered; its status remains in the [existing implementation handoff](../plans/dashboard_cli_workflow_parity/research-stack-implementation-handoff.md).
...
- HEAD: `8058fcf42d89bc4bba7d88576843e684c5fedca3`.
- The working tree contains modified and untracked implementation files. A current-checkout inventory must be labelled a development snapshot, not a clean release of HEAD.
...
- Submodule checkouts observed: IsaacLab `ffff603eafc6b74264a5261cc0183d6a65390d78`; Isaac-GR00T `7b8f37ec16763df6765768f0e0ef692a357870af`. Record gitlink and actual checkout identities separately at execution time, including dirty/missing states.
- Syft, Trivy, cdxgen, cyclonedx-py and Grype were not found on the current PATH. This is not a claim that no scanner exists elsewhere or in an image.
