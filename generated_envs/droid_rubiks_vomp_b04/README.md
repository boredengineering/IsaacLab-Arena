...
* **Task Description**: Droid robot picks up the Rubik's cube from the maple table and places it into the compact bin_b04_vomp_robolab container.
* **Task Composition**: `TaskCompositionType.ATOMIC`
* **Embodiment**: `droid_abs_joint_pos`
* **Background Anchor**: `maple_table_robolab`
* **Scene Objects**: `rubiks_cube` (`rubiks_cube_hot3d_robolab`), `blue_bin` (`bin_b04_vomp_robolab`)
...
docker exec -it \
  ...
  --num_envs 1 \
  --enable_cameras \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_rubiks_vomp_b04/droid_pick_rubiks_cube_to_blue_bin.yaml \
...
docker exec -it \
  ...
  --base_spec /workspaces/isaaclab_arena/generated_envs/droid_rubiks_vomp_b04/droid_pick_rubiks_cube_to_blue_bin.yaml \
  --feedback "Your refinement instruction here..." \
  --out_dir /workspaces/isaaclab_arena/generated_envs/droid_rubiks_vomp_b04_refined
```
...
docker exec -it \
  ...
  --assets rubiks_cube_hot3d_robolab bin_b04_vomp_robolab \
