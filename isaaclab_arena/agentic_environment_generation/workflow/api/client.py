...
DOCUMENTS["result"] = (
    ...
    " provenanceSha256 manifestSha256 disposition freshArtifactVerification } } ... on NotFound { code } ... on"
    " QueryFailure { code } "
