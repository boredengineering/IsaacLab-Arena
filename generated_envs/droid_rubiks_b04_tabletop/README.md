...
docker exec -it \
  ...
  --enable_cameras \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_rubiks_b04_tabletop/droid_rubiks_cube_to_bin.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_rubiks_cube_to_bin_gr00t_single
```
...
docker exec -it \
  ...
  --policy_device cuda \
  --env_graph_spec_yaml /workspaces/isaaclab_arena/generated_envs/droid_rubiks_b04_tabletop/droid_rubiks_cube_to_bin.yaml \
  --output_base_dir /workspaces/isaaclab_arena/eval_output/droid_rubiks_cube_to_bin_gr00t_parallel
```
