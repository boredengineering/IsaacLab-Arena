...
class G1PinkStaticPickAndPlaceEnvironment(ExampleEnvironmentBase):
    """G1 Pink (Agile WBC + Pink IK) pick-and-place on the locomanip warehouse shelf.
    ...
    name: str = "g1_pink_static_pick_and_place"
