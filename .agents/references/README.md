...
| [Event Mapping Refactoring Plan 03](plans/event-mapping-refactoring_plan_03.md) | Bottom-up Neo4j-only application refactoring for GraphQL; not execution authorization | No SQLite runtime authority/fallback; domain and existing engines → shared commands/read models → GraphQL; dashboard deferred |
